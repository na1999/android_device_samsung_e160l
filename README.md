...
<manifest>
  ...
  <project name="Socim/android_device_samsung_E160" path="device/samsung/E160L" revision="E160L" />
  <project name="Socim/android_vendor_samsung_E160L" path="vendor/samsung/E160L" revision="E160L" />
</manifest>
```
...
```
. build/envsetup.sh
. build/tools/device/makerecoveries.sh cm_E160L-eng 
```
